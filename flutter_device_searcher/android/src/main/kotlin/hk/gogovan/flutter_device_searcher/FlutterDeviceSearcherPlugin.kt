...
class FlutterDeviceSearcherPlugin: FlutterPlugin, MethodCallHandler, ActivityAware {
  ...
  override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    channel = MethodChannel(flutterPluginBinding.binaryMessenger, "hk.gogovan.flutter_device_searcher")
    channel.setMethodCallHandler(this)

    bluetoothScanChannel = EventChannel(flutterPluginBinding.binaryMessager, "hk.gogovan.flutter_device_searcher.bluetoothScan")
  }
